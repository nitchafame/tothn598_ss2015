...
void main() {
    ...
    a = snoise(pos*vec2(cos(u_time*0.1),sin(u_time*0.9))*0.1)*3.1415;
    vel = vec2(cos(a),sin(a));
    DF += snoise(pos+vel)*0.15+0.25;

    offset = doubleCubicSeat (0.9*DF,0.9,fract(DF));
