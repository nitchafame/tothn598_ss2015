...
vec3 color1 = vec3(0.761,0.133,0.114);
vec3 color2 = vec3(0.847,0.592,0.231);
vec3 color3 = vec3(0.262,0.167,0.396);
vec3 color4 = vec3(0.275,0.102,0.267);
